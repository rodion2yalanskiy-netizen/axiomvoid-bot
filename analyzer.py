...
def classify_note(text: str) -> dict:
    ...
    """
    # Разрешённые папки — только существующие, без emoji!
    ALLOWED_FOLDERS = {
        "Бизнес QSNera": ["Клиенты", "Задачи", "Отчёты", "Маркетинг", "Сайт"],
        "Цифровой мозг": ["Brain", "Система", "Саморазвитие", "Работа над собой"],
        "Личная жизнь":  ["Цели", "Дневник"],
...
- "Личная жизнь" папки: "Цели", "Дневник"
...
- Личные цели, планы, мечты → Личная жизнь / Цели
- Дневник, личные мысли, эмоции → Личная жизнь / Дневник
